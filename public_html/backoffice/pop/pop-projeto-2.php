                ...
                <div class="col-md-12">
                    <div class="box box-solid">
                        <div class="box-header">
                            ...
                            <?php if ($infoProjeto['finalizado'] != 1) { ?>media
                                <?php if (isset($briefing['elemento'])) { ?>
                                ...
                                <a class="btn btn-primary btn-flat btn-addnew border-0" href="#"
                                   ...
                                   data-target="#modal-arquivar-projeto"
                                   data-toggle="modal" data-backdrop="static">
                                    <i class="fa fa-archive pull-left font-16"></i> Arquivar Projeto
                                </a>
                                <a class="btn btn-primary btn-flat btn-addnew border-0" href="#"
                                   data-projeto="<?php echo $infoProjeto['projeto']; ?>"
                                   data-target="#modal-editar-projeto"
                                   data-toggle="modal" data-backdrop="static">
                            ...
                            <div class="row">
                                <div class="col-sm-12 filtros">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="acao-bts">
                                                <button class="btn btn-primary btn-flat btn-addnew border-0" data-toggle="modal" data-backdrop="static" data-target="#"><i class="fa fa-plus"></i> Adicionar novo item</button>
                                            </div>
                                        </div>
                                        -->
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4">
                                                    ...
                                                    <div class="box-body chat historico-post" id="chat-box">
                                                        <?php
                                                        $chatProjeto = $POPChat->getProjetoChat($e['projeto']);
                                                                    ...
                                                                    <a href="#" class="name">
                                                                        <small title="<?php echo date('d/m/Y - H:i:s', strtotime($itemChat['data'])); ?>"
                                                                               class="text-muted pull-right"><i
                                                                                    class="fa fa-clock-o"></i> <?php echo Utils::printDate(date('Y-m-d H:i:s', strtotime($itemChat['data']))); ?>
                                                                        </small>
                                                                        <?php echo $var->retornaNomeExibicao(); ?>
                                                                    </a>
                                                                    <?php echo $itemChat['conteudo']; ?><br>
                                                                    <br>
                                                                </p>
                                                            </div>
                                                        <?php } ?>
                                                    ...
                                                    <dd>
                                                        <p><a href="#" class="js-getProjeto"
                                                              data-elemento="<?php echo $e['projeto']; ?>"
                                                              data-toggle="modal" data-backdrop="static"
                                                              data-target="#modal-elemento"
                                                              data-acao="ver-historico-projeto">Ver todo o histórico</a>
                                                        </p>
                                                    </dd>
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        <?php
                                                        $lista_botoes = $POPBotao->getElementButtonsById($e);
                                                        foreach ($lista_botoes as $botao) {
                                                            echo $POPBotao->montaBotaoElemento($e["elemento"], $botao["botao"]) . PHP_EOL;
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    $(document).on('click', '.js-ajax-pop-2', function (event) {
        ...
        console.log(idModal, idElemento, botao);
        //console.log(acao);
        var loadModal = true;
        if (botao === lastModal) {
            loadModal = false;
