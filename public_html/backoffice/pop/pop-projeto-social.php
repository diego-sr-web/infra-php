...
foreach ($elementosProjeto as $key => $value) {
    ...
    if (isset($value["campos"]["dataPublicacao"])) {
        $elementosProjeto[$key]["sort"] = strtotime($value["campos"]["dataPublicacao"]);
    }
}
                                ...
                                <div class="col-sm-7">
                                    <dl class="dl-horizontal">
                                        ...
                                        <?php foreach ($tarefasProjeto as $tarefa) {
                                            ...
                                            // soh tarefas que realmente estao em andamento
                                            // $arrayStatus = [4];
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-info-post-social"
                                                                title="Aprovar">
                                                        ...
                                                        if (isset($e["campos"]["Etapa"])) {
                                                            $array_sem_reprova = [180, 182, 191, 193];
                                                            $array_reprova_condicional = [188, 189];
