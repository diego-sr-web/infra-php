                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="ver-referencias" title="Ver Referências">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                title="<?php echo $POPElemento->adicionarOuAlterar($briefing, 'link_2', ' Link da Campanha'); ?>">
                                                            <i class="fa fa-image pull-left"></i> <?php echo $POPElemento->adicionarOuAlterar($briefing, 'link_2', ' Link da Campanha'); ?>
                                                        </button>
