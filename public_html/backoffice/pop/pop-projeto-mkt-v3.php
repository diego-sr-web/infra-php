<?php
$identifier = "POP_PROJETO_EMAIL-MARKETING";
                    ...
                    <div class="box box-solid">
                        <div class="box-header">
                            ...
                            <?php if ($infoProjeto['finalizado'] != 1) { ?>
                                <a class="btn btn-primary btn-flat btn-addnew border-0 js-getProjeto"
                                   data-projeto="<?php echo $infoProjeto["projeto"]; ?>"
                                   data-toggle="modal" data-backdrop="static"
                                   data-target="#modal-projeto" data-acao="adicionar-briefing-projeto"
                                   title="Briefing">
                                    <i class="fa fa-file-text pull-left"></i> Instruções do Email Marketing
                                </a>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="acao-bts">
                                                <button class="btn btn-primary btn-flat btn-addnew border-0 js-getProjeto"
                                                        data-toggle="modal" data-backdrop="static"
                                                        data-target="#modal-projeto"
                                                        data-acao="novo-e-mail-mkt"
                                                        data-projeto="<?php echo $infoProjeto['projeto']; ?>"><i
                                                            class="fa fa-plus"></i>
                                                    Adicionar Novo E-mail Mkt
                                                </button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-7 col-md-5 item-info-list">
                                                    <div class="row">
                                                        ...
                                                        foreach ($subE as $field) {
                                                            $discarted_fields = ["briefing", "extras", "arquivos", "referencia", "prioridade", "responsavel", "EtapaReprovacao", "AreaTipo"];
                                                            if (in_array($field["nome"], $discarted_fields)) {
                                                                continue;
                                                            }
                                                            $nome = $field["nome"] . ":404:";
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-briefing-mail-mkt"
                                                                title="Briefing">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-info-mail-mkt"
                                                            ...
                                                            $array_alterar = [];
                                                            $array_ver = [];
                                                            if (in_array($e["campos"]["Etapa"], $array_revisar)) { ?>
                                                                Revisar
                                                            <?php } elseif (in_array($e["campos"]["Etapa"], $array_alterar)) { ?>
                                                                Alterar
                                                            <?php } elseif (in_array($e["campos"]["Etapa"], $array_ver)) { ?>
                                                                Ver
                                                            <?php } else { ?>
                                                                Adicionar
                                                            <?php } ?>Conteúdo
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-url-drive"
                                                                title="Adicionar URL Google Drive">
                                                            <i class="fa fa-pencil pull-left"></i> Drive da Arte
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-url-html"
                                                                title="Adicionar URL Studionerdweb">
                                                            <i class="fa fa-pencil pull-left"></i> Link do HTML
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-texto"
                                                                title="Adicionar Texto Simples">
                                                            <i class="fa fa-pencil pull-left"></i> Adicionar Texto
                                                            Simples
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="ver-referencias-imagem"
                                                                title="Ver Referências">
                                                            <i class="fa fa-pencil pull-left"></i> Material Extra
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-success border-0 js-getElemento"
                                                            ...
                                                            <?php
                                                            $array_entregar = [349, 350, 351, 353, 357, 364, 360, 367, 372, 374, 377];
                                                            $array_finalizar = [378, 411, 431];
                                                            if (in_array($e["campos"]["Etapa"], $array_entregar)) { ?>
                                                                Entregar Job
                                                            <?php } elseif (in_array($e['campos']["Etapa"], $array_finalizar)) { ?>
                                                                Finalizar Tarefa
                                                            <?php } else { ?>
                                                                Aprovar Tarefa
                                                            <?php } ?>
                                                        ...
                                                        if (isset($e["campos"]["Etapa"])) {
                                                            $array_sem_reprova = [349, 350, 353, 360, 367, 374, 400, 401, 408, 410, 411, 420, 421, 428, 430, 431];
                                                            $array_reprova_condicional = [363, 370, 404, 405, 424, 425];
