<?php
$identifier = "POP_PROJETO_MATERIAL_GRAFICO";
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                title="<?php echo $POPElemento->adicionarOuAlterar($briefing, 'arquivos', ' Link da Campanha'); ?>">
                                                            <i class="fa fa-image pull-left"></i> <?php echo $POPElemento->adicionarOuAlterar($briefing, 'arquivos', ' Link Material Gráfico'); ?>
                                                        </button>
