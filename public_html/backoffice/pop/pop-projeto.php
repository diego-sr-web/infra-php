<?php
$identifier = "POP_DEFAULT_PROJECT";
                                        ...
                                        <div class="col-sm-4">
                                            <div class="acao-bts">
                                                <button class="btn btn-primary btn-flat btn-addnew border-0"
                                                        data-toggle="modal" data-backdrop="static" data-target="#"><i
                                                            class="fa fa-plus"></i> Adicionar novo item
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-imagem" title="Adicionar Imagem">
                                                            <i class="fa fa-image pull-left"></i> Adicionar Imagem
                                                        </button>
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                data-elemento="<?php echo $e['elemento']; ?>"
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-texto" title="Adicionar Texto">
                                                            <i class="fa fa-file-text pull-left"></i> Adicionar Texto
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-danger border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="apagar-elemento" title="Apagar Item">
                                                            <i class="fa fa-times pull-left"></i> Apagar Item
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
