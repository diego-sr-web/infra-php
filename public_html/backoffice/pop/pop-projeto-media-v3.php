                    ...
                    <div class="box box-solid">
                        <div class="box-header">
                            ...
                            <a class="btn btn-primary btn-flat btn-addnew border-0 js-getProjeto"
                               ...
                               title="Briefing">
                                <i class="fa fa-file-text pull-left"></i> Instruções da Campanha
                            </a>
                                                ...
                                                <div class="col-lg-7 col-md-5 item-info-list">
                                                    <div class="row">
                                                        ...
                                                        foreach ($subE as $field) {
                                                            $discarted_fields = ["briefing", "extras", "arquivos", "prioridade", "responsavel", "EtapaReprovacao"];
                                                ...
                                                <div class="col-lg-2 col-md-3" <?php if ($esconde_Botoes) {
                                                    ...
                                                    <div class="item-btns">
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-briefing-pecas-media"
                                                                title="Briefing">
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-dados-pecas-media"
                                                                title="Briefing">
                                                            <i class="fa fa-file-text pull-left"></i> Conteudo
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-primary border-0 js-getElemento"
                                                                ...
                                                                data-toggle="modal" data-backdrop="static"
                                                                data-target="#modal-elemento"
                                                                data-acao="adicionar-drive-2-pecas-media"
                                                                title="Briefing">
                                                            <i class="fa fa-bullhorn pull-left"></i> Plano de Midia
                                                        </button>
                                                        ...
                                                        <button class="btn btn-block btn-flat btn-success border-0 js-getElemento"
                                                            ...
                                                            <?php
                                                            $array_entregar = [300, 301, 302, 303, 305, 308, 310, 317, 319, 322, 323, 326];
                                                            $array_finalizar = [324,];
                                                        ...
                                                        if (isset($e["campos"]["Etapa"])) {
                                                            $array_sem_reprova = [300, 305, 310, 326];
                                                            $array_reprova_condicional = [311,312, 314];
