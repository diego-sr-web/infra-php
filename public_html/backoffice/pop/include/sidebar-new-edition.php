    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php if (in_array($arquivo, $arquivos_monitor, FALSE)) {
            ...
            <ul class="treeview-menu" style="display:block;">
                ...
                <li><a href="pop-monitor.php?tipo=12"><i class="fa fa-angle-double-right"></i> Email Marketing</a></li>
        ...
        */ ?>
        ...
        <?php $arquivos_menu = ['pop-fluxos.php', 'pop-categorias.php']; ?>

        <!--
            <?php if ($infoUsuario['administrador'] == AREA_ADMIN) { ?>
                <li class="treeview <?php if (in_array($arquivo, $arquivos_menu, FALSE)) {
            echo 'active';
        } ?>">
                    <a href="#">
                        <i class="fa fa-folder-open"></i> <span>Configurações</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="pop-fluxos.php"><i class="fa fa-code-fork"></i> <span>Construção de Fluxos</span></a></li>
                        <li><a href="pop-categorias.php"><i class="fa fa-angle-double-right"></i> Categorias de Post</a></li>
                    </ul>
                </li>
            <?php } ?>
        -->
        ...
        <li class="treeview <?php if (in_array($arquivo, $arquivos_menu, FALSE)) {
            ...
            <a href="#">
                <i class="fa fa-folder-open"></i> <span>Clientes&Servicos</span>
                <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
                <li><a href="/backoffice/clientes.php"><i class="fa fa-users"></i> <span>Clientes</span></a></li>
                <li><a href="/backoffice/servicos.php"><i class="fa fa-angle-double-right"></i>Servicos</a></li>
            </ul>
        </li>
