    ...
    public function retornaHtmlExibicao() {
        ...
        if ($imagem !== "" && $imagem !== NULL) {
            $html .= '<a class="open-lightbox" href="' . $imagem . '" target="_blank">
                           <img src="' . $imagem . '" style="border: 1px solid #E0E8E8;">
                          </a>';
        }
        else {
            $html .= '<img src="/backoffice/pop/uploads/projeto/default.jpg" style="border: 1px solid #E0E8E8;">';
        }
        return $html;
    }
